<body>
 <form>
  ...
  <fieldset>                                       <!-- следующий столбец -->
    <label>категория</label><SELECT></SELECT>      <!-- тут из базы грузим -->   
  ...
  <fieldset>
    <label>цена</label><input type="text"></input> <!-- из базы грузим данные при выборе второго селекта(изделие) и умножаем на количество -->
    <div></div>                                    <!-- тут список сданных работ этим чертом в этом месяце + возможность выбора другого временного интервала -->
  </fieldset>
